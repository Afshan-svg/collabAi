(function () {
  ...
  container.innerHTML = `
      <div id="assistant-embed-container">
        ...
        <div id="assistant-embed" style="position:fixed;bottom:20px;right:20px;width:610px;height:780px;border:1px solid #ccc;border-radius:10px;display:none;z-index:9999;">
